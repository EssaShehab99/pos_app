                      ...
                      children: [
                        ...
                        SlidingUpPanel(
                          borderRadius: const BorderRadiusDirectional.only(
                              topEnd:
                                  Radius.circular(ConstantsValues.borderRadius * 3)),
                          boxShadow: [
                            BoxShadow(
                              color: ColorsApp.shadow,
                              blurRadius: 1,
                                ...
                                children: [
                                  ...
                                  Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        margin:
                                            EdgeInsets.all(ConstantsValues.padding),
                                        decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(
                                                ConstantsValues.borderRadius * 0.5),
                                            border:
                                                Border.all(color: ColorsApp.shadow)),
                                        child: Row(
                                          mainAxisAlignment:
                                  ...
                                  Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        child: ListView.builder(
                                          itemCount:
                                              value.salesInvoice?.products.length ??
                                                  0,
